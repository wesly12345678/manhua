<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="UpdateComicInfo.aspx.cs" Inherits="manhua.comicCreator.UpdateComicInfo" %>
   ...
   <div class="haha">
    ...
    <div class="form">
        ...
        <p>
            Vip can view?
            <div>
                <asp:RadioButtonList ID="rblVipView" runat="server">
